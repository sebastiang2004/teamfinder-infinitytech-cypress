export default function AbilityDetails({skill}) {
  ...
  return (
    <>
      ...
      {/*  </div>*/}
      {/*  <div className="custom-label text-[15px]">*/}
      {/*    <p className="mt-5">Iriciuc marina</p>*/}
      ...
      {/*<p className="mt-2">Mabel A. Young</p>*/}
      {/*<p className="custom-label">The department manager who added this skill</p>*/}
      {/*<p className="mt-2">Jerry J. Rhoads</p>*/}
      {/*<p className="custom-label">List of departments where this skill is used</p>*/}
      {/*<ul>*/}
      {/*  <li>FE</li>*/}
      {/*  <li>BE</li>*/}
      {/*  <li>QA</li>*/}
      ...
      {/*</ul>*/}
      {/*<p>Statistici</p>*/}
      {/*<p>Nr total de persoane cu aceasta abilitate</p>*/}
      {/*<p>Nr total de persoane cu aceasta abilitate la nivelul 1</p>*/}
      {/*<p>Nr total de persoane cu aceasta abilitate la nivelul 2</p>*/}
      {/*<p>Nr total de persoane cu aceasta abilitate la nivelul 3</p>*/}
      {/*<p>Nr total de persoane cu aceasta abilitate la nivelul 4</p>*/}
      {/*<p>Nr total de persoane cu aceasta abilitate la nivelul 5</p>*/}
      {/*<p>Nr total de persoane cu aceasta abilitate la nivelul 6</p>*/}
      {/*diagrama circulara*/}
    </>
